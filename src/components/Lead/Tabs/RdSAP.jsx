...
export default function RdSAP({ title, field = {}, show, onSaveTab }) {
    ...
    return (
        <div className={show ? 'block' : 'hidden'}>
            <div className='grid grid-cols-1 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-4 mt-8'>
                ...
                <FormDropdown label='Scheme' name='scheme' placeholder='Scheme'
                ...
                <div className="col-span-full">
                    <FormTextBox label="Notes" name="notes_2" placeholder="Enter Notes"
